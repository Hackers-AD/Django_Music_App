	...
	{%if songs%}
		...
		<ol style="padding: 0px;font-weight: bold;">
		    ...
		    <li class="navbar navbar-default" style="margin:0;padding-bottom: 30px;padding-top: 25px;" id="{{song.id}}">
		    	...
		    	<audio src="{{song.song_file.url}}" id="audio"></audio>
		    	<span class="optspan">
		    		<span class="glyphicon glyphicon-play" onclick="PlaySong('{{song.id}}')" id="play"></span>
	...
	<div>
		...
		<center>
			<button class="btn btn-success btn-lg" onclick="window.open('/createalbum/','_parent')">
				<span class="glyphicon glyphicon-plus"></span> Create Album <span class="glyphicon glyphicon-film"></span>
		    </button>
	    </center>
	</div>
	{%endif%}
