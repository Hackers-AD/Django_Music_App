...
<body>
	...
	<center>
		<span style="color: green;">
	        <big><span class="glyphicon glyphicon-saved"></span> Song is sucessfully added. Add another song. </big>
	    </span><br><br>
    
	    <a href="/uploadsong/">
		    <button class="btn btn-primary btn-lg">
		    	<span class="glyphicon glyphicon-plus-sign"></span> Add Next Song
		    </button>
	    </a>
	    <a href="/tubelight/">
